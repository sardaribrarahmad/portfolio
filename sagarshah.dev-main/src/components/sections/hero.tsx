      ...
      <div className="flex flex-col gap-12 md:flex-row">
        ...
        <div className="flex max-w-3xl flex-grow flex-col justify-center gap-8 md:order-first md:items-start md:justify-center 2xl:gap-12">
          <div className="flex flex-col gap-2">
            ...
            in creating scalable, user-centric web applications and have
            successfully delivered complex solutions using the MERN stack. My
            expertise includes designing efficient APIs, building responsive
            UIs, and managing NoSQL databases. I aspire to continue innovating
            in web development, leveraging cutting-edge technologies to deliver
